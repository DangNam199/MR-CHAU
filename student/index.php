  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a> Chung <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="schedule.php">Lịch</a></li>
                      <li><a href="schedule.php">Điểm</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
        ...
        <!-- page content -->
        <div class="right_col" role="main" style="min-height: 1000.8px;">
          <!-- top tiles -->
