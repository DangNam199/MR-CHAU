                                    ...
                                    <div class="well profile_view">
                                        ...
                                        <div class=" profile-bottom text-center">
                                            <div class=" row-sm-6 emphasis">
                                                <a class="btn btn-app" href="../php/room/edit_room.php?id=<?php echo  $row['id'];?>"><i class="fa fa-edit"> </i> Sửa </a>
                                                <a class="btn btn-app" href="../php/room/delete_room.php?id=<?php echo  $row['id'];?>" ><i  class="fa fa-close"> </i> Xóa</a>
