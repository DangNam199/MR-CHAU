...
$result_room = array();
if($query_room){
    while($row = mysqli_fetch_assoc($query_room)){
        $result_room = $row;
    }
}
...
if (isset($_POST['submit'])){
    ...
    $sql = "UPDATE room SET name = '$name',tinhtrang = '$tinhtrang', seat = '$seat' WHERE id = '$ID'";
                                ...
                                <form  method="post">
                                    <div class="field item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="name" required="required" value="<?=$result_room['name']?>" />
                                        </div>
                                    </div>
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Số ghế<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" type="number" name="seat" required='required' data-validate-length-range="1,15" value="<?=$result_room['seat']?>"/></div>
                                    </div>
                                    <div class="field item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3  label-align">Tình trạng<span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6">
                                            <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="tinhtrang" required="required" value="<?=$result_room['tinhtrang']?>"/>
                                        </div>
                                    </div>
                                    <div class="ln_solid">
