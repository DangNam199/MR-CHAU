...
if (!empty($_POST['search'])){
    $name = $_POST['search'];
    $sql = "SELECT * FROM tailieu WHERE tenTL LIKE '%".$name."%'";
                ...
                <div class="page-title">
                    ...
                    <div class="title_right">
                        <div class="col-md-5 col-sm-5  form-group pull-right top_search">
                            <form method="post" action="search_documents.php">
                                    ...
                                    <div class="well profile_view">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="right col-md-5 col-sm-5 text-center">
                                                <img src="../<?=$row['image']?>" class="img-circle img-fluid" alt="avatar" title="avatar">
                                            </div>
                                        </div>
