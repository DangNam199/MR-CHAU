<?php 
    ...
    $sql = "SELECT * FROM slideshow where state = 'primary'";
    ...
    if (isset($_POST['submit']))
    {
      ...
      $sql_update = "UPDATE `slideshow` SET `pic1`='$file1',`pic2`='$file2',`pic3`='$file3' WHERE id = 1";
                  ...
                  <div class="x_content">
                      ...
                      <div class="clearfix"></div>
                        <div class="x_content">
                                    ...
                                    <?php if (isset($res['pic1'])) {echo 'Đã có ảnh';} ?>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Ảnh 1<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                            <input class="form-control" type="file" name="image1"  required='required'/></div>
                                        </div> 
                                        <?php if (isset($res['pic2'])) {echo 'Đã có ảnh';} ?>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Ảnh 2<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                            <input class="form-control" type="file" name="image2"  required='required'/></div>
                                        </div>
                                        <?php if (isset($res['pic3'])) {echo 'Đã có ảnh';} ?>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Ảnh 3 <span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="file" name="image3"  required='required'/></div>
                                            </div> 
                                        </div>
                                        <div class="ln_solid">
