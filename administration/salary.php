                ...
                <div class="x_panel">
                  <div class="x_content">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          <?php  
                            $sql = "SELECT chamcong.id as 'chamcong_id', `shift_begin`, `staff_id`, `shift_end`, `real_begin`, `real_end`, `date`, `real_work_time`, chamcong.state as 'chamcong_state', nhanvien.TenNV FROM `chamcong` INNER JOIN nhanvien on chamcong.staff_id = nhanvien.id where real_work_time is NULL and chamcong.state = 'pendding' ORDER BY date";
                          ...
                          <td class=" "id = 'staff-<?=$row['chamcong_id']?>'><?=$row['staff_id']?></td>
                            ...
                            <td class=" " ><?=$true?></td>
                            <td class=" " id="real-<?=$row['chamcong_id'] ?>" ><?=$real?></td>
