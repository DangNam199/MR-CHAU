                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Tên phiếu chi<span class="required">*</span></label>
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Số tiền<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <select  class="form-control" class='number' id="type"  type="number" >
                                                   <option value="maintenance">Chi phí duy trì</option>
                                        ...
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    <button id='submit' class="btn btn-primary">Tạo mới và in hoá đơn</button>
