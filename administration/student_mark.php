<?php 
    ...
    if (isset($_GET['student_id']) && isset($_GET['class_id'])){
      ...
      $sql = "SELECT hocvien.name as 'student_name', hocvien.id as 'student_id', mark.class_id as 'class_id' ,mark.mark as 'mark', mark.type as 'type', mark.date as 'mark_date' from mark INNER JOIN hocvien on mark.student_id = hocvien.id WHERE hocvien.id = ". $_GET['student_id'] ." and hocvien.class_id = $class_id ORDER BY `hocvien`.`name`, type ";
            ...
            <div class="row">
                <div class="x_panel">
                  <div class="x_content">
                      ...
                      <p id ='student-id' hidden> <?=$_GET['student_id']?> </p>
