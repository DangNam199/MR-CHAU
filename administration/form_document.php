...
if (isset($_POST['submit']) && empty($_FILES['image']['tmp_name'])==false){
    ...
    $sql = "INSERT INTO `tailieu`(`id`, `tenTL`, `noidung`, `image`, `soluong`, `price`) VALUES (null,'$name','$content','$file','$soluong','$price')";
    $res = mysqli_query($conn, $sql);
    if($res){
        header("location: all_document.php");
    }
                                ...
                                <div class="x_content">
                                    <form  method="post" enctype="multipart/form-data">
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Tên tài liệu<span class="required">*</span></label>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="content" required="required" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="number" name="soluong" value=0 required='required' data-validate-length-range="1,15" /></div>
                                        </div>
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Giá<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" type="number" value=0 name="price" required='required' data-validate-length-range="1,15" /></div>
                                        </div>
                                        <div class="field item form-group">
