<?php 
    ...
    $res = mysqli_query($conn,$sql);
      ...
      $sql = "SELECT homework.name as 'homework_name', deadline, file, homework.id, homework.state  FROM homework INNER JOIN hocvien on homework.class_id = hocvien.class_id where hocvien.id =". $_SESSION['id']. ' ORDER by homework.id';;  
      $res = mysqli_query($conn,$sql);
    }
