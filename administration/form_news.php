              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a> Phòng Học <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="../administration/form_news.php">Thêm Phòng</a></li>
                      <li><a href="all_news.php">Tất Cả Phòng</a></li>
                    </ul>
                  </li>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form  action="../php/add_events.php" method="post" enctype="multipart/form-data">
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Tên tin tức<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="news_name" required="required" />
                                            </div>
                                        </div>
                                        <div class="field item form-group">
                                        ...
                                        <textarea class="ckeditor" id="ckeditor1" name = "textarea"></textarea>
