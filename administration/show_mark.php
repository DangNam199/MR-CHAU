<?php 
    ...
    if (isset($_GET['class_id'])){
      ...
      $sql = "SELECT hocvien.name as 'student_name', hocvien.id as 'student_id', mark.class_id as 'class_id' ,mark.mark as 'mark', mark.type as 'type', mark.date as 'mark_date' from mark INNER JOIN hocvien on mark.student_id = hocvien.id WHERE mark.class_id = ". $_GET['class_id'] ." ORDER BY `hocvien`.`name`, type ";
