<?php 
    ...
    if (isset($_POST['submit']) && isset($_POST['mark'])){
      ...
      while ($row_mark = mysqli_fetch_assoc($res)){
        ...
        if (!isset($_GET['homework'])){
        $sql_mark .= "INSERT INTO `mark`(`id`, `class_id`, `student_id`, `mark`, `date`) VALUES (null,'$class_id','$student_id','$marks[$count]',now());";
        }
        else {
          $sql_mark .= "INSERT INTO `mark`(`id`, `class_id`, `student_id`, `mark`, `date`,   `homework_id`) VALUES (null,'$class_id','$student_id','$marks[$count]',now(), $homework_id);";
        }
        $count ++;
      }
