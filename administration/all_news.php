                ...
                <div class="page-title">
                    ...
                    <div class="title_right">
                        <div class="col-md-5 col-sm-5  form-group pull-right top_search">
                            <form method="post" action="../php/news/search_news.php">
                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <?php while ($row = mysqli_fetch_array($res)) { ?>
                                <div class="col-md-4 col-sm-4  profile_details" id="news-<?= $row['id'] ?>">
                                    <div class="well profile_view">
                                        <div class="col-sm-12">
                                            <div class="left col-md-7 col-sm-7">
                                                <h2><?= $row['TenTT'] ?></h2>

                                                <!-- <p><strong>Certificate: </strong> <?= $row['NoiDungTT'] ?> </p> -->
                                                <!-- <ul class="list-unstyled">
                              <li><i class="fa fa-building"></i>Address: <?= $row['address'] ?> </li>
                              </ul> -->
                                            </div>
                                            <div class="right col-md-5 col-sm-5 text-center">
                                                <img src="<?= $row['thumbnail'] ?>" class="img-circle img-fluid"
                                                     alt="avatar" title="avatar">
                                            </div>
                                        </div>
                                        <div class=" profile-bottom text-center">
                                            <div class=" row-sm-6 emphasis">
                                                <a class="btn btn-app" href="../php/news/edit_news.php?id=<?php
                                                echo $row['id'];
                                                ?>"
                                                ><i class="fa fa-edit"> </i> View News</a>
    ...
    function deleteAjax(id) {
        if (confirm('Are you sure delete this employee')) {
            $.ajax({
                ...
                data: {
                    id: id,
                    table: 'tintuc', //ten bang trong csdl
                },
