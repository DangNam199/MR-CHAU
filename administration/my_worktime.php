                ...
                <div class="x_panel">
                  <div class="x_content">
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            <th class="column-title">Ngày Chấm </th>
                        ...
                        <tbody>
                            ...
                            <?php 
                                if($row['state'] == 'approve'){
                                    echo " <td class=' '><button class='btn btn-success'>Được duyệt</button></td>";
                                }
                                else{
                                    echo " <td class=' '><button class='btn btn-danger'>Chưa được duyệt</button></td>";
                                }
                            ?>
                          </tr>
                          <?php }?>
