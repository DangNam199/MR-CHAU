...
;(function(root, factory){
    ...
    FormValidator.prototype = {
        ...
        texts : {
            invalid         : 'Vui lòng nhập lại',
            short           : 'Quá ngắn',
            long            : 'Quá dài',
            checked         : 'Phải được chọn',
            empty           : 'Hãy nhập gì đó',
            ...
            email_repeat    : 'emails không khớp',
            date            : 'Ngày không đúng',
            time            : 'Thời gian không đúng',
            password_repeat : 'Mật khẩu không khớp',
            no_match        : 'Không khớp',
            complete        : 'Chưa được hoàn thành'
        },
